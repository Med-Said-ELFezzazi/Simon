...
public class Palabreo2 extends JFrame implements ActionListener{
	...
	private void tratarEventos() {
		...
		txtIntento.addKeyListener(new KeyAdapter() {
	...
	public class EscuchadorVentana extends MouseAdapter{
